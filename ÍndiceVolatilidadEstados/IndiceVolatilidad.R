# Primer ejecicio para un índice de volatilidad

library(tidyverse)
library(FactoMineR) #Para hacer PCA
...
write.csv(nl.clean, file = "raw/nuevo_leon_volatilidad.csv", row.names = FALSE)
...
write.csv(nl.final, "out/indice_nuevo_leon.csv", row.names = FALSE)
